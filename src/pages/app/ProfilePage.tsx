  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <Card className="mb-5">
        <CardHeader>
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-[#1E4D8C] text-white flex items-center justify-center text-lg font-bold shrink-0">
              {isLoading ? (
          ...
          {isLoading ? (
            ...
            <>
              ...
              {usage && (
                <div
                  role="progressbar"
                  aria-valuenow={Math.round((usage.used / usage.limit) * 100)}
                  aria-valuemin={0}
                  aria-valuemax={100}
                  aria-label={`${Math.round((usage.used / usage.limit) * 100)}% of monthly document limit used`}
      ...
      {!isLoading && usage?.plan === 'FREE' && (
        <Card className="mb-5 border-[#1E4D8C]/20 bg-gradient-to-br from-blue-50 to-white">
          <CardContent>
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-xl bg-[#1E4D8C]/10 flex items-center justify-center shrink-0">
                <Star className="w-5 h-5 text-[#1E4D8C]" />
              </div>
              <div className="flex-1">
                <p className="text-base font-semibold text-slate-900 mb-1">Upgrade to Premium</p>
